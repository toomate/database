...
-- Removida a coluna 'rotatividade' pois na DDL ela pertence à tabela 'insumo'
...
-- Adicionada a coluna 'rotatividade' que estava na categoria, removida a 'unidadeMedida' e atualizada a 'fkCategoria'
INSERT INTO insumo (fkCategoria, nome, qtdMinima, rotatividade) VALUES
    (4, 'Leite Integral',      10, 1),
    (4, 'Queijo Mussarela',    5,  1),
    (1, 'Frango Inteiro',      8,  1),
    (1, 'Carne Bovina Moída',  10, 1),
    (6, 'Arroz Branco',        20, 0),
    (6, 'Feijão Carioca',      15, 0),
    (7, 'Sal Refinado',        5,  0),
    (8, 'Óleo de Soja',        6,  0),
    (9, 'Refrigerante 2L',     24, 0),
    (9, 'Água Mineral 500ml',  50, 0),
    (4, 'Creme de Leite',      8,  1),
    (4, 'Manteiga',            6,  1),
    (4, 'Iogurte Natural',     12, 1),
    (4, 'Requeijao Cremoso',   5,  1),
    (4, 'Leite Condensado',    10, 1),
    (4, 'Queijo Prato',        7,  1),
    (1, 'Peito de Frango',     9,  1),
    (1, 'Coxa e Sobrecoxa',    9,  1),
    (1, 'Carne Suina',         8,  1),
    (5, 'Linguica Toscana',    7,  1),
    (5, 'Bacon',               6,  1),
    (2, 'File de Tilapia',     6,  1),
    (6, 'Acucar Refinado',     18, 0),
    (6, 'Farinha de Trigo',    16, 0),
    (6, 'Macarrao Espaguete',  20, 0),
    (6, 'Lentilha',            12, 0),
    (6, 'Grao de Bico',        10, 0),
    (3, 'Milho Verde',         24, 1),
    (7, 'Pimenta do Reino',    4,  0),
    (7, 'Colorau',             4,  0),
    (7, 'Acafrao',             3,  0),
    (7, 'Vinagre Alcool',      8,  0),
    (7, 'Molho de Tomate',     20, 1),
    (7, 'Shoyu',               6,  0),
    (9, 'Suco de Laranja 1L',  18, 1),
    (9, 'Suco de Uva 1L',      18, 1),
    (9, 'Cha Gelado 1.5L',     15, 1),
    (9, 'Energetico 269ml',    30, 0),
    (9, 'Agua com Gas 500ml',  40, 0),
    (9, 'Isotonico 500ml',     24, 0);
...
-- Adicionada unidadeMedida respectiva de cada produto, um valor para quantidadeTotal e corrigido o nome de 'dataEntrada'
INSERT INTO lote (fkMarca, fkUsuario, precoUnit, unidadeMedida, quantidadeMedida, quantidadeTotal, dataEntrada, dataValidade) VALUES
    ...
    (3, 2, ROUND(10.00 + RAND() * 3.00, 2), 'kg', ROUND(1 + RAND() * 4, 1),   FLOOR(10 + RAND() * 30),  DATE_SUB(CURDATE(), INTERVAL 5 DAY), DATE_SUB(CURDATE(), INTERVAL 2 DAY)),
...
INSERT INTO lote (fkMarca, fkUsuario, precoUnit, unidadeMedida, quantidadeMedida, quantidadeTotal, dataEntrada, dataValidade) VALUES
    ...
    (15, 2, ROUND(5.50 + RAND() * 1.50, 2),  'un', ROUND(10 + RAND() * 12, 1), FLOOR(40 + RAND() * 60),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 8 MONTH)),
    (16, 3, ROUND(32.00 + RAND() * 8.00, 2), 'kg', ROUND(4 + RAND() * 5, 1),   FLOOR(10 + RAND() * 20),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 28 DAY)),
    (17, 1, ROUND(12.00 + RAND() * 3.00, 2), 'kg', ROUND(8 + RAND() * 10, 1),  FLOOR(30 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 4 DAY)),
    (18, 2, ROUND(11.00 + RAND() * 3.00, 2), 'kg', ROUND(8 + RAND() * 9, 1),   FLOOR(30 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 DAY)),
    (19, 3, ROUND(23.00 + RAND() * 7.00, 2), 'kg', ROUND(6 + RAND() * 8, 1),   FLOOR(20 + RAND() * 40),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 9 DAY)),
    (20, 1, ROUND(17.00 + RAND() * 5.00, 2), 'kg', ROUND(7 + RAND() * 8, 1),   FLOOR(25 + RAND() * 45),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 12 DAY)),
    (21, 2, ROUND(28.00 + RAND() * 8.00, 2), 'kg', ROUND(4 + RAND() * 5, 1),   FLOOR(15 + RAND() * 30),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 20 DAY)),
    (22, 3, ROUND(31.00 + RAND() * 9.00, 2), 'kg', ROUND(5 + RAND() * 6, 1),   FLOOR(20 + RAND() * 35),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 DAY)),
    (23, 1, ROUND(4.50 + RAND() * 1.50, 2),  'kg', ROUND(20 + RAND() * 20, 1), FLOOR(100 + RAND() * 150),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 12 MONTH)),
    (24, 2, ROUND(5.00 + RAND() * 1.60, 2),  'kg', ROUND(18 + RAND() * 18, 1), FLOOR(90 + RAND() * 140), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 MONTH)),
    (25, 3, ROUND(3.20 + RAND() * 1.20, 2),  'un', ROUND(25 + RAND() * 20, 1), FLOOR(120 + RAND() * 200),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 14 MONTH)),
    (26, 1, ROUND(8.00 + RAND() * 2.00, 2),  'kg', ROUND(10 + RAND() * 12, 1), FLOOR(40 + RAND() * 70),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 9 MONTH)),
    (27, 2, ROUND(11.00 + RAND() * 3.00, 2), 'kg', ROUND(9 + RAND() * 10, 1),  FLOOR(35 + RAND() * 60),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 11 MONTH)),
    (28, 3, ROUND(2.80 + RAND() * 1.10, 2),  'un', ROUND(22 + RAND() * 18, 1), FLOOR(100 + RAND() * 150),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 MONTH)),
    (29, 1, ROUND(52.00 + RAND() * 15.00, 2),'kg', ROUND(1 + RAND() * 2, 1),   FLOOR(5 + RAND() * 10),   CURDATE(), DATE_ADD(CURDATE(), INTERVAL 24 MONTH)),
    (30, 2, ROUND(6.00 + RAND() * 2.00, 2),  'kg', ROUND(6 + RAND() * 8, 1),   FLOOR(20 + RAND() * 40),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 18 MONTH)),
    (31, 3, ROUND(35.00 + RAND() * 10.00, 2),'kg', ROUND(2 + RAND() * 3, 1),   FLOOR(10 + RAND() * 15),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 20 MONTH)),
    (32, 1, ROUND(3.80 + RAND() * 1.30, 2),  'L',  ROUND(8 + RAND() * 8, 1),   FLOOR(30 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 16 MONTH)),
    (33, 2, ROUND(4.20 + RAND() * 1.40, 2),  'un', ROUND(12 + RAND() * 10, 1), FLOOR(40 + RAND() * 70),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 14 MONTH)),
    (34, 3, ROUND(9.00 + RAND() * 3.00, 2),  'L',  ROUND(7 + RAND() * 8, 1),   FLOOR(25 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 MONTH)),
    (35, 1, ROUND(7.50 + RAND() * 2.50, 2),  'un', ROUND(18 + RAND() * 18, 1), FLOOR(80 + RAND() * 120), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 MONTH)),
    (36, 2, ROUND(8.00 + RAND() * 2.70, 2),  'un', ROUND(18 + RAND() * 16, 1), FLOOR(80 + RAND() * 110), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 MONTH)),
    (37, 3, ROUND(6.20 + RAND() * 2.20, 2),  'un', ROUND(15 + RAND() * 14, 1), FLOOR(60 + RAND() * 90),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 4 MONTH)),
    (38, 1, ROUND(9.50 + RAND() * 3.50, 2),  'un', ROUND(20 + RAND() * 20, 1), FLOOR(100 + RAND() * 150),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 MONTH)),
    (39, 2, ROUND(2.10 + RAND() * 1.20, 2),  'un', ROUND(25 + RAND() * 20, 1), FLOOR(120 + RAND() * 180),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 2 YEAR)),
    (40, 3, ROUND(4.80 + RAND() * 1.80, 2),  'un', ROUND(20 + RAND() * 18, 1), FLOOR(90 + RAND() * 130), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 9 MONTH)),
    (5,  1, ROUND(5.20 + RAND() * 1.50, 2),  'kg', ROUND(18 + RAND() * 15, 1), FLOOR(80 + RAND() * 120), DATE_SUB(CURDATE(), INTERVAL 20 DAY), DATE_SUB(CURDATE(), INTERVAL 3 DAY)),
    (18, 2, ROUND(10.50 + RAND() * 2.50, 2), 'kg', ROUND(6 + RAND() * 7, 1),   FLOOR(20 + RAND() * 40),  DATE_SUB(CURDATE(), INTERVAL 8 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY)),
    (27, 3, ROUND(10.80 + RAND() * 2.80, 2), 'kg', ROUND(8 + RAND() * 8, 1),   FLOOR(30 + RAND() * 60),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 13 MONTH));
