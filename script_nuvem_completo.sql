...
INSERT INTO lote (fkMarca, fkUsuario, precoUnit, unidadeMedida, quantidadeMedida, quantidadeTotal, dataEntrada, dataValidade) VALUES
    (1, 1, ROUND(3.50 + RAND() * 2.00, 2),  'L',  ROUND(15 + RAND() * 20, 1), FLOOR(50 + RAND() * 100), CURDATE(), DATE_ADD(CURDATE(), INTERVAL  5 DAY)),
    (2, 2, ROUND(35.00 + RAND() * 8.00, 2), 'kg', ROUND(5 + RAND() * 8, 1),   FLOOR(20 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 15 DAY)),
    (3, 1, ROUND(11.00 + RAND() * 3.50, 2), 'kg', ROUND(8 + RAND() * 8, 1),   FLOOR(30 + RAND() * 60),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL  3 DAY)),
    (4, 1, ROUND(27.00 + RAND() * 6.00, 2), 'kg', ROUND(12 + RAND() * 8, 1),  FLOOR(40 + RAND() * 80),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL  7 DAY)),
    (5, 3, ROUND(4.99 + RAND() * 1.50, 2),  'kg', ROUND(25 + RAND() * 20, 1), FLOOR(100 + RAND() * 200),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 12 MONTH)),
    (6, 3, ROUND(6.50 + RAND() * 1.80, 2),  'kg', ROUND(20 + RAND() * 15, 1), FLOOR(80 + RAND() * 150), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 MONTH)),
    (7, 2, ROUND(2.50 + RAND() * 1.20, 2),  'kg', ROUND(8 + RAND() * 6, 1),   FLOOR(50 + RAND() * 100), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 24 MONTH)),
    (8, 2, ROUND(7.50 + RAND() * 3.00, 2),  'L',  ROUND(10 + RAND() * 8, 1),  FLOOR(60 + RAND() * 80),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 18 MONTH)),
    (9, 1, ROUND(8.50 + RAND() * 3.00, 2),  'un', ROUND(30 + RAND() * 20, 1), FLOOR(150 + RAND() * 300),CURDATE(), DATE_ADD(CURDATE(), INTERVAL  6 MONTH)),
    (10, 3, ROUND(0.90 + RAND() * 0.80, 2), 'un', ROUND(50 + RAND() * 30, 1), FLOOR(200 + RAND() * 500),CURDATE(), DATE_ADD(CURDATE(), INTERVAL  2 YEAR)),
    (11, 1, ROUND(4.00 + RAND() * 2.00, 2),  'L',  ROUND(10 + RAND() * 15, 1), FLOOR(40 + RAND() * 60),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 20 DAY)),
    (12, 2, ROUND(18.00 + RAND() * 6.00, 2), 'kg', ROUND(6 + RAND() * 8, 1),   FLOOR(20 + RAND() * 40),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 40 DAY)),
    (13, 3, ROUND(6.00 + RAND() * 2.00, 2),  'L',  ROUND(12 + RAND() * 18, 1), FLOOR(50 + RAND() * 80),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 25 DAY)),
    (14, 1, ROUND(14.00 + RAND() * 4.00, 2), 'kg', ROUND(5 + RAND() * 7, 1),   FLOOR(15 + RAND() * 30),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 35 DAY)),
    (15, 2, ROUND(32.00 + RAND() * 8.00, 2), 'kg', ROUND(4 + RAND() * 5, 1),   FLOOR(10 + RAND() * 20),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 28 DAY)),
    (16, 1, ROUND(12.00 + RAND() * 3.00, 2), 'kg', ROUND(8 + RAND() * 10, 1),  FLOOR(30 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 4 DAY)),
    (17, 2, ROUND(11.00 + RAND() * 3.00, 2), 'kg', ROUND(8 + RAND() * 9, 1),   FLOOR(30 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 DAY)),
    (18, 3, ROUND(23.00 + RAND() * 7.00, 2), 'kg', ROUND(6 + RAND() * 8, 1),   FLOOR(20 + RAND() * 40),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 9 DAY)),
    (19, 1, ROUND(17.00 + RAND() * 5.00, 2), 'kg', ROUND(7 + RAND() * 8, 1),   FLOOR(25 + RAND() * 45),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 12 DAY)),
    (20, 2, ROUND(28.00 + RAND() * 8.00, 2), 'kg', ROUND(4 + RAND() * 5, 1),   FLOOR(15 + RAND() * 30),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 20 DAY)),
    (21, 3, ROUND(31.00 + RAND() * 9.00, 2), 'kg', ROUND(5 + RAND() * 6, 1),   FLOOR(20 + RAND() * 35),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 DAY)),
    (22, 1, ROUND(4.50 + RAND() * 1.50, 2),  'kg', ROUND(20 + RAND() * 20, 1), FLOOR(100 + RAND() * 150),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 12 MONTH)),
    (23, 2, ROUND(5.00 + RAND() * 1.60, 2),  'kg', ROUND(18 + RAND() * 18, 1), FLOOR(90 + RAND() * 140), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 MONTH)),
    (24, 3, ROUND(3.20 + RAND() * 1.20, 2),  'un', ROUND(25 + RAND() * 20, 1), FLOOR(120 + RAND() * 200),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 14 MONTH)),
    (25, 1, ROUND(8.00 + RAND() * 2.00, 2),  'kg', ROUND(10 + RAND() * 12, 1), FLOOR(40 + RAND() * 70),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 9 MONTH)),
    (26, 2, ROUND(11.00 + RAND() * 3.00, 2), 'kg', ROUND(9 + RAND() * 10, 1),   FLOOR(35 + RAND() * 60),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 11 MONTH)),
    (27, 3, ROUND(2.80 + RAND() * 1.10, 2),  'un', ROUND(22 + RAND() * 18, 1), FLOOR(100 + RAND() * 150),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 MONTH)),
    (28, 1, ROUND(52.00 + RAND() * 15.00, 2),'kg', ROUND(1 + RAND() * 2, 1),   FLOOR(5 + RAND() * 10),   CURDATE(), DATE_ADD(CURDATE(), INTERVAL 24 MONTH)),
    (29, 2, ROUND(6.00 + RAND() * 2.00, 2),  'kg', ROUND(6 + RAND() * 8, 1),   FLOOR(20 + RAND() * 40),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 18 MONTH)),
    (30, 3, ROUND(35.00 + RAND() * 10.00, 2),'kg', ROUND(2 + RAND() * 3, 1),   FLOOR(10 + RAND() * 15),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 20 MONTH)),
    (31, 1, ROUND(3.80 + RAND() * 1.30, 2),  'L',  ROUND(8 + RAND() * 8, 1),   FLOOR(30 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 16 MONTH)),
    (32, 2, ROUND(4.20 + RAND() * 1.40, 2),  'un', ROUND(12 + RAND() * 10, 1), FLOOR(40 + RAND() * 70),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 14 MONTH)),
    (33, 3, ROUND(9.00 + RAND() * 3.00, 2),  'L',  ROUND(7 + RAND() * 8, 1),   FLOOR(25 + RAND() * 50),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 10 MONTH)),
    (34, 1, ROUND(7.50 + RAND() * 2.50, 2),  'un', ROUND(18 + RAND() * 18, 1), FLOOR(80 + RAND() * 120), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 MONTH)),
    (35, 2, ROUND(8.00 + RAND() * 2.70, 2),  'un', ROUND(18 + RAND() * 16, 1), FLOOR(80 + RAND() * 110), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 5 MONTH)),
    (36, 3, ROUND(6.20 + RAND() * 2.20, 2),  'un', ROUND(15 + RAND() * 14, 1), FLOOR(60 + RAND() * 90),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 4 MONTH)),
    (37, 1, ROUND(9.50 + RAND() * 3.50, 2),  'un', ROUND(20 + RAND() * 20, 1), FLOOR(100 + RAND() * 150),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 MONTH)),
    (38, 2, ROUND(2.10 + RAND() * 1.20, 2),  'un', ROUND(25 + RAND() * 20, 1), FLOOR(120 + RAND() * 180),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 2 YEAR)),
    (39, 3, ROUND(4.80 + RAND() * 1.80, 2),  'kg', ROUND(20 + RAND() * 18, 1), FLOOR(90 + RAND() * 130), CURDATE(), DATE_ADD(CURDATE(), INTERVAL  1 MONTH)),
    (40, 1, ROUND(12.00 + RAND() * 4.00, 2), 'kg', ROUND(10 + RAND() * 10, 1), FLOOR(40 + RAND() * 80),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL  2 MONTH));

-- BLOCO DE LOTES 2: Segundo lote para cada uma das 40 marcas (Garante o mínimo de 2 lotes por marca)
INSERT INTO lote (fkMarca, fkUsuario, precoUnit, unidadeMedida, quantidadeMedida, quantidadeTotal, dataEntrada, dataValidade) VALUES
    (1, 2, ROUND(3.40 + RAND() * 2.00, 2),  'L',  ROUND(10 + RAND() * 15, 1), FLOOR(30 + RAND() * 80),  DATE_SUB(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 3 DAY)),
    (2, 3, ROUND(36.00 + RAND() * 5.00, 2), 'kg', ROUND(4 + RAND() * 6, 1),   FLOOR(15 + RAND() * 40),  DATE_SUB(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 10 DAY)),
    (3, 2, ROUND(10.00 + RAND() * 3.00, 2), 'kg', ROUND(5 + RAND() * 5, 1),   FLOOR(20 + RAND() * 40),  DATE_SUB(CURDATE(), INTERVAL 5 DAY), DATE_SUB(CURDATE(), INTERVAL 1 DAY)),
    (4, 3, ROUND(26.50 + RAND() * 5.00, 2), 'kg', ROUND(10 + RAND() * 5, 1),  FLOOR(30 + RAND() * 60),  DATE_SUB(CURDATE(), INTERVAL 3 DAY), DATE_ADD(CURDATE(), INTERVAL 4 DAY)),
    (5, 1, ROUND(5.20 + RAND() * 1.50, 2),  'kg', ROUND(18 + RAND() * 15, 1), FLOOR(80 + RAND() * 120), DATE_SUB(CURDATE(), INTERVAL 20 DAY), DATE_ADD(CURDATE(), INTERVAL 11 MONTH)),
    (6, 1, ROUND(6.10 + RAND() * 1.50, 2),  'kg', ROUND(15 + RAND() * 15, 1), FLOOR(70 + RAND() * 120), DATE_SUB(CURDATE(), INTERVAL 15 DAY), DATE_ADD(CURDATE(), INTERVAL 9 MONTH)),
    (7, 3, ROUND(2.40 + RAND() * 1.00, 2),  'kg', ROUND(5 + RAND() * 5, 1),   FLOOR(40 + RAND() * 80),  DATE_SUB(CURDATE(), INTERVAL 30 DAY), DATE_ADD(CURDATE(), INTERVAL 23 MONTH)),
    (8, 1, ROUND(7.20 + RAND() * 2.00, 2),  'L',  ROUND(8 + RAND() * 5, 1),   FLOOR(50 + RAND() * 70),  DATE_SUB(CURDATE(), INTERVAL 10 DAY), DATE_ADD(CURDATE(), INTERVAL 17 MONTH)),
    (9, 2, ROUND(8.20 + RAND() * 2.00, 2),  'un', ROUND(20 + RAND() * 15, 1), FLOOR(100 + RAND() * 200),DATE_SUB(CURDATE(), INTERVAL 4 DAY), DATE_ADD(CURDATE(), INTERVAL 5 MONTH)),
    (10, 1, ROUND(0.85 + RAND() * 0.50, 2), 'un', ROUND(40 + RAND() * 20, 1), FLOOR(150 + RAND() * 350),DATE_SUB(CURDATE(), INTERVAL 8 DAY), DATE_ADD(CURDATE(), INTERVAL 23 MONTH)),
    (11, 2, ROUND(4.10 + RAND() * 1.50, 2), 'L',  ROUND(8 + RAND() * 10, 1),  FLOOR(30 + RAND() * 50),  DATE_SUB(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 18 DAY)),
    (12, 3, ROUND(17.50 + RAND() * 5.00, 2), 'kg', ROUND(5 + RAND() * 5, 1),   FLOOR(15 + RAND() * 30),  DATE_SUB(CURDATE(), INTERVAL 4 DAY), DATE_ADD(CURDATE(), INTERVAL 36 DAY)),
    (13, 1, ROUND(5.80 + RAND() * 1.50, 2), 'L',  ROUND(10 + RAND() * 10, 1), FLOOR(40 + RAND() * 70),  DATE_SUB(CURDATE(), INTERVAL 3 DAY), DATE_ADD(CURDATE(), INTERVAL 22 DAY)),
    (14, 3, ROUND(13.50 + RAND() * 3.00, 2), 'kg', ROUND(4 + RAND() * 5, 1),   FLOOR(10 + RAND() * 25),  DATE_SUB(CURDATE(), INTERVAL 1 DAY), DATE_ADD(CURDATE(), INTERVAL 34 DAY)),
    (15, 1, ROUND(31.00 + RAND() * 6.00, 2), 'kg', ROUND(3 + RAND() * 4, 1),   FLOOR(8 + RAND() * 15),   DATE_SUB(CURDATE(), INTERVAL 6 DAY), DATE_ADD(CURDATE(), INTERVAL 22 DAY)),
    (16, 2, ROUND(11.50 + RAND() * 2.50, 2), 'kg', ROUND(6 + RAND() * 8, 1),   FLOOR(20 + RAND() * 45),  DATE_SUB(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY)),
    (17, 3, ROUND(10.50 + RAND() * 2.50, 2), 'kg', ROUND(6 + RAND() * 7, 1),   FLOOR(20 + RAND() * 40),  DATE_SUB(CURDATE(), INTERVAL 8 DAY), DATE_ADD(CURDATE(), INTERVAL 2 DAY)),
    (18, 1, ROUND(22.00 + RAND() * 5.00, 2), 'kg', ROUND(5 + RAND() * 5, 1),   FLOOR(15 + RAND() * 35),  DATE_SUB(CURDATE(), INTERVAL 3 DAY), DATE_ADD(CURDATE(), INTERVAL 6 DAY)),
    (19, 2, ROUND(16.50 + RAND() * 4.00, 2), 'kg', ROUND(5 + RAND() * 5, 1),   FLOOR(20 + RAND() * 35),  DATE_SUB(CURDATE(), INTERVAL 4 DAY), DATE_ADD(CURDATE(), INTERVAL 8 DAY)),
    (20, 3, ROUND(27.00 + RAND() * 6.00, 2), 'kg', ROUND(3 + RAND() * 4, 1),   FLOOR(10 + RAND() * 25),  DATE_SUB(CURDATE(), INTERVAL 5 DAY), DATE_ADD(CURDATE(), INTERVAL 15 DAY)),
    (21, 1, ROUND(30.00 + RAND() * 7.00, 2), 'kg', ROUND(4 + RAND() * 4, 1),   FLOOR(15 + RAND() * 30),  DATE_SUB(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 8 DAY)),
    (22, 2, ROUND(4.30 + RAND() * 1.00, 2),  'kg', ROUND(15 + RAND() * 15, 1), FLOOR(80 + RAND() * 120), DATE_SUB(CURDATE(), INTERVAL 12 DAY), DATE_ADD(CURDATE(), INTERVAL 11 MONTH)),
    (23, 3, ROUND(4.80 + RAND() * 1.20, 2),  'kg', ROUND(12 + RAND() * 12, 1), FLOOR(70 + RAND() * 110), DATE_SUB(CURDATE(), INTERVAL 18 DAY), DATE_ADD(CURDATE(), INTERVAL 9 MONTH)),
    (24, 1, ROUND(3.00 + RAND() * 1.00, 2),  'un', ROUND(20 + RAND() * 15, 1), FLOOR(100 + RAND() * 150),DATE_SUB(CURDATE(), INTERVAL 10 DAY), DATE_ADD(CURDATE(), INTERVAL 13 MONTH)),
    (25, 2, ROUND(7.50 + RAND() * 1.50, 2),  'kg', ROUND(8 + RAND() * 8, 1),   FLOOR(30 + RAND() * 50),  DATE_SUB(CURDATE(), INTERVAL 14 DAY), DATE_ADD(CURDATE(), INTERVAL 8 MONTH)),
    (26, 3, ROUND(10.50 + RAND() * 2.00, 2), 'kg', ROUND(7 + RAND() * 7, 1),   FLOOR(25 + RAND() * 50),  DATE_SUB(CURDATE(), INTERVAL 20 DAY), DATE_ADD(CURDATE(), INTERVAL 10 MONTH)),
    (27, 1, ROUND(2.60 + RAND() * 0.90, 2),  'un', ROUND(18 + RAND() * 12, 1), FLOOR(80 + RAND() * 120), DATE_SUB(CURDATE(), INTERVAL 5 DAY),  DATE_ADD(CURDATE(), INTERVAL 6 MONTH)),
    (28, 2, ROUND(50.00 + RAND() * 10.00, 2),'kg', ROUND(1 + RAND() * 1, 1),   FLOOR(4 + RAND() * 6),    DATE_SUB(CURDATE(), INTERVAL 45 DAY), DATE_ADD(CURDATE(), INTERVAL 22 MONTH)),
    (29, 3, ROUND(5.80 + RAND() * 1.50, 2),  'kg', ROUND(5 + RAND() * 5, 1),   FLOOR(15 + RAND() * 30),  DATE_SUB(CURDATE(), INTERVAL 15 DAY), DATE_ADD(CURDATE(), INTERVAL 17 MONTH)),
    (30, 1, ROUND(33.00 + RAND() * 7.00, 2), 'kg', ROUND(1 + RAND() * 2, 1),   FLOOR(8 + RAND() * 12),   DATE_SUB(CURDATE(), INTERVAL 8 DAY),  DATE_ADD(CURDATE(), INTERVAL 19 MONTH)),
    (31, 2, ROUND(3.60 + RAND() * 1.00, 2),  'L',  ROUND(6 + RAND() * 6, 1),   FLOOR(20 + RAND() * 40),  DATE_SUB(CURDATE(), INTERVAL 12 DAY), DATE_ADD(CURDATE(), INTERVAL 15 MONTH)),
    (32, 3, ROUND(4.00 + RAND() * 1.00, 2),  'un', ROUND(10 + RAND() * 8, 1),  FLOOR(30 + RAND() * 50),  DATE_SUB(CURDATE(), INTERVAL 6 DAY),  DATE_ADD(CURDATE(), INTERVAL 13 MONTH)),
    (33, 1, ROUND(8.50 + RAND() * 2.00, 2),  'L',  ROUND(5 + RAND() * 5, 1),   FLOOR(15 + RAND() * 35),  DATE_SUB(CURDATE(), INTERVAL 25 DAY), DATE_ADD(CURDATE(), INTERVAL 9 MONTH)),
    (34, 2, ROUND(7.00 + RAND() * 2.00, 2),  'un', ROUND(12 + RAND() * 12, 1), FLOOR(60 + RAND() * 100), DATE_SUB(CURDATE(), INTERVAL 4 DAY),  DATE_ADD(CURDATE(), INTERVAL 4 MONTH)),
    (35, 3, ROUND(7.60 + RAND() * 2.00, 2),  'un', ROUND(12 + RAND() * 10, 1), FLOOR(60 + RAND() * 90),  DATE_SUB(CURDATE(), INTERVAL 5 DAY),  DATE_ADD(CURDATE(), INTERVAL 4 MONTH)),
    (36, 1, ROUND(5.90 + RAND() * 1.50, 2),  'un', ROUND(10 + RAND() * 10, 1), FLOOR(40 + RAND() * 70),  DATE_SUB(CURDATE(), INTERVAL 10 DAY), DATE_ADD(CURDATE(), INTERVAL 3 MONTH)),
    (37, 2, ROUND(9.00 + RAND() * 2.50, 2),  'un', ROUND(15 + RAND() * 15, 1), FLOOR(80 + RAND() * 120), DATE_SUB(CURDATE(), INTERVAL 3 DAY),  DATE_ADD(CURDATE(), INTERVAL 6 MONTH)),
    (38, 3, ROUND(2.00 + RAND() * 0.90, 2),  'un', ROUND(20 + RAND() * 15, 1), FLOOR(100 + RAND() * 140),DATE_SUB(CURDATE(), INTERVAL 6 DAY),  DATE_ADD(CURDATE(), INTERVAL 23 MONTH)),
    (39, 1, ROUND(4.50 + RAND() * 1.00, 2),  'kg', ROUND(15 + RAND() * 15, 1), FLOOR(60 + RAND() * 100), DATE_SUB(CURDATE(), INTERVAL 4 DAY),  DATE_ADD(CURDATE(), INTERVAL 20 DAY)),
    (40, 2, ROUND(11.00 + RAND() * 3.00, 2), 'kg', ROUND(8 + RAND() * 8, 1),   FLOOR(30 + RAND() * 60),  DATE_SUB(CURDATE(), INTERVAL 5 DAY),  DATE_ADD(CURDATE(), INTERVAL 45 DAY));

-- BLOCO DE LOTES 3: Terceiro lote para produtos de altíssima saída em restaurantes (Arroz, Feijão, Bebidas, Cebola)
INSERT INTO lote (fkMarca, fkUsuario, precoUnit, unidadeMedida, quantidadeMedida, quantidadeTotal, dataEntrada, dataValidade) VALUES
    (5,  1, ROUND(5.30 + RAND() * 1.00, 2),  'kg', ROUND(20 + RAND() * 10, 1), FLOOR(90 + RAND() * 110), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 14 MONTH)),
    (6,  2, ROUND(6.40 + RAND() * 1.00, 2),  'kg', ROUND(18 + RAND() * 10, 1), FLOOR(80 + RAND() * 110), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 11 MONTH)),
    (9,  3, ROUND(8.60 + RAND() * 1.50, 2),  'un', ROUND(25 + RAND() * 15, 1), FLOOR(120 + RAND() * 180),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 7 MONTH)),
    (16, 1, ROUND(12.20 + RAND() * 2.00, 2), 'kg', ROUND(7 + RAND() * 5, 1),   FLOOR(25 + RAND() * 40),  CURDATE(), DATE_ADD(CURDATE(), INTERVAL 6 DAY)),
    (24, 2, ROUND(3.30 + RAND() * 1.00, 2),  'un', ROUND(22 + RAND() * 10, 1), FLOOR(110 + RAND() * 160),CURDATE(), DATE_ADD(CURDATE(), INTERVAL 15 MONTH)),
    (39, 3, ROUND(4.90 + RAND() * 1.00, 2),  'kg', ROUND(25 + RAND() * 10, 1), FLOOR(80 + RAND() * 120), CURDATE(), DATE_ADD(CURDATE(), INTERVAL 25 DAY));
